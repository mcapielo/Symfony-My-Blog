...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(\Doctrine\Common\Persistence\ObjectManager $manager)
    {
        ...
        $blog1->setTags('symfony2, php, paradise, my blog');
        ...
        $blog2->setTags('pool, leaky, hacked, movie, hacking, my blog');
        ...
        $blog3->setTags('misdirection, magic, movie, hacking, my blog');
        ...
        $blog4->setTags('grid, daftpunk, movie, my blog');
        ...
        $blog5->setTags('binary, one, zero, alive, dead, !trusting, movie, my blog');
